...
namespace Dialogue_Quest.Window
{
    public class Graph_View : GraphView
    {
        ...
        private Dictionary<string, Basic_Node> start_nodes;
        ...
        private void Add_Maniplators()
        {
            ...
            //Add Menu
            ContextualMenuManipulator Add_Menu = new ContextualMenuManipulator(Event =>
                Event.menu.AppendAction("Mark as Start Point",
                    actionEvent => { get_selection_of_nodes(0); }));

            //Remove menu
            ContextualMenuManipulator Del_menu = new ContextualMenuManipulator(Event =>
                Event.menu.AppendAction("UnMark Start Point",
        ...
        {
            ContextualMenuManipulator Menu = new ContextualMenuManipulator(Event =>
                Event.menu.AppendAction(action_title,
                    action_Event =>
                        AddElement(Create_Node(action_Event.eventInfo.localMousePosition, parent_node_type,
                            Node_type))));
            return Menu;
        }
        ...
        private void Add_Graph_Styles()
        {
            StyleSheet styleSheet =
                (StyleSheet)EditorGUIUtility.Load("Assets/Editor Default Resources/UIVariables/Graph_style.uss");
        ...
        */
            ...
            switch (mode)
            {
                case 0: //Adds to list of start points
                    foreach (Basic_Node node_To_Add in selected_base_nodes)
                    {
                        ...
                        start_nodes.Add(node_To_Add.ID, node_To_Add);
                    }
        ...
        public Dictionary<string, Basic_Node> get_start_points()
        {
            return start_nodes;
        }
    #endregion
